...
export default function Header() {
  ...
  const menuItems = [
    ...
    { label: "Blog", href: "https://adapty.io/blog/" },
    { label: "Pricing", href: "https://adapty.io/pricing/" },
    { label: "web2app", href: "https://funnelfox.com/", external: true, gradient: true },
  ];
        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-6">
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-1.5 bg-black text-white rounded-lg text-xs font-medium flex items-center gap-1.5 hover:bg-gray-800 transition-colors"
              >
                EN
                <svg className="w-3 h-3" fill="none" viewBox="0 0 448 512">
                  <path
          ...
          <div className="hidden lg:flex items-center gap-6">
            <a
              ...
              className="text-gray-900 hover:text-violet-600 font-medium text-sm transition-colors"
            >
              Log in
            </a>
            <a
              href="https://app.adapty.io/registration"
              className="px-4 py-2 border-2 border-violet-600 text-violet-600 hover:bg-violet-50 font-semibold rounded-lg transition-colors text-sm flex items-center gap-2"
            >
              Sign up
            ...
            <a
              ...
              className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-lg transition-colors text-sm flex items-center gap-2"
            >
              Contact sales
              <svg className="w-3 h-3" fill="none" viewBox="0 0 8 12">
                <path
          ...
          <div className="lg:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col gap-4">
              ...
              <div className="pt-4 border-t border-gray-200 flex flex-col gap-3">
                ...
                <a
                  href="https://app.adapty.io/registration"
                  className="px-4 py-2 border-2 border-violet-600 text-violet-600 hover:bg-violet-50 font-semibold rounded-lg transition-colors text-sm text-center"
                >
                  Sign up
                </a>
                <a
                  href="https://adapty.io/schedule-demo/"
                  className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-lg transition-colors text-sm text-center"
                >
                  Contact sales
                </a>
              </div>
